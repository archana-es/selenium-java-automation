...
public class MoreLocators {
    ...
    public static void main(String[] args){
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[class*='submit']"))).click();
    ...
    public static String getPassword(WebDriver driver){
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        wait.until(ExpectedConditions.elementToBeClickable(By.className("reset-pwd-btn"))).click();
